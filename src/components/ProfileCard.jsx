                ...
                isLoaded ?
                 <div className="flip-card-inner">
                    ...
                    <ContentLoader
                        ...
                        id="AA"
                    >
                        <circle id="a1" cx="341" cy="35" r="23" />
                        <rect id="a2" x="38" y="25" rx="5" ry="5" width="234" height="17" />
                        <rect id="a3" x="39" y="83" rx="5" ry="5" width="337" height="15" />
                        <rect id="a4" x="254" y="135" rx="5" ry="5" width="123" height="12" />
                    </ContentLoader>
                </div>
            }
        </div>
