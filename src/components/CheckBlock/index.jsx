    ...
    return (
        <div className="form-control w-full">
            <label className="label cursor-pointer flex items-center justify-between space-x-3 w-full">
                ...
                <input autoComplete='false' checked={state} onChange={(e) => setState(e.target.checked)} type="checkbox" className="checkbox border-2 border-white bg-black text-white" />
            </label>
            {
