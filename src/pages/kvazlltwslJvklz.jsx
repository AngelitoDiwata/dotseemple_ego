...
export default function DotSeempleCodes() {
    ...
    return (
        <div className='App w-full h-fit bg-black'>
            ...
            <div className='w-full h-screen bg-black flex flex-col items-center justify-start md:items-start md:grid md:grid-cols-3 md:justify-center space-y-5 md:space-y-0 mx-10 my-10 gap-2'>
                {
