                ...
                }
                {
                    loginState && <div className="absolute z-30 bg-black top-0 w-full m-auto flex flex-col md:flex-row items-start md:items-end justify-between py-5 space-y-3 md:space-x-3 space-x-0 md:space-y-0 px-10">
                        <div className='w-full md:w-fit flex flex-row items-center justify-start space-x-3'>
                            ...
                            <button className="w-1/2 md:w-full lg:w-20 hover:scale-110 transition-all font-semibold border hover:font-neutral-900 hover:border-2 border-white bg-black rounded-lg outline-white px-3 py-1 text-white" onClick={() => fetchDB(searchVal)}>Search</button>
                        </div>
